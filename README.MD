...
<h3 align="center">A passionate data/AI enthusiast, project manager and process improvement enthusiast from Brazil</h3>
...
|---------------------------------|--------------------------------------------------------------------------------------|-----------------------------------------------------------------|------------------------------|
| Rag Project                   | An intelligent legal document Q&A system using RAG to answer questions about Court of Accounts precedents with semantic search and automated metadata filtering.   | [RAG Project](https://github.com/realdanizilla/rag-project-jornada)       | LangChain, LangGraph, Langfuse, Qdrant, Streamlit, OpenAI GPT, MarkItDown, Python          
